...
TFuture<TArray<FFAAObjectDataStruct>> UObstaclesUtil::GetFAADOFObjects(USPLogger* Log, FString LogOrigin, float Lon, float Lat, int32 RadiusNM) {
...
TFuture<FADSBObjectDataResult> UObstaclesUtil::GetADSBObjects(USPLogger* Log, FString LogOrigin, float Lon, float Lat, int32 RadiusNM) {
