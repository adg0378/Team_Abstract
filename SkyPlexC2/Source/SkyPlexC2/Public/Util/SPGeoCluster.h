...
#include "SPGeoCluster.generated.h"
...
/**
 * Emits events based on the geographical locations and clustering of objects
 */
UCLASS(BlueprintType, Blueprintable)
class SKYPLEXC2_API USPGeoCluster : public UObject
{
	GENERATED_BODY()
