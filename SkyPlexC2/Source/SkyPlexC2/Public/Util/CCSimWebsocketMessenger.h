...
#include "CCSimWebsocketMessenger.generated.h"
...
/**
 * Utility class to assist with websocket messages
 */
UCLASS(Blueprintable)
class SKYPLEXC2_API UCCSimWebsocketMessenger : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
