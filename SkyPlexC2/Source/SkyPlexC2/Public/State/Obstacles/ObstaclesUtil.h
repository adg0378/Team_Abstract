...
#include "ObstaclesUtil.generated.h"
...
/**
 * Utility functions for managing obstacles
 */
UCLASS()
class SKYPLEXC2_API UObstaclesUtil : public UObject
{
	GENERATED_BODY()
	
public:
	static TFuture<TArray<FFAAObjectDataStruct>> GetFAADOFObjects(USPLogger* Log, FString LogOrigin, float Lon, float Lat, int32 RadiusNM);
